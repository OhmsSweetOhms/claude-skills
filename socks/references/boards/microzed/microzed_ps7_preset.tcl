# microzed_ps7_preset.tcl - PS7 configuration for MicroZed 7020
# Converted from Avnet bdf/microzed_7020/1.4/preset.xml
#
# Usage: source this file, then call apply_microzed_preset $ps7_cell

proc apply_microzed_preset {ps7_cell} {
    ...
    ] [get_bd_cells $ps7_cell]

    # Print key parameters for verification
    puts "=== MicroZed PS7 Preset Applied ==="
    puts "  FCLK0:    [get_property CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ [get_bd_cells $ps7_cell]] MHz"
    puts "  DDR part: [get_property CONFIG.PCW_UIPARAM_DDR_PARTNO [get_bd_cells $ps7_cell]]"
    puts "  UART1:    [get_property CONFIG.PCW_UART1_UART1_IO [get_bd_cells $ps7_cell]]"
}
